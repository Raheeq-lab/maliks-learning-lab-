            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  {...field}
                  className="bg-white border-white/10 focus:border-purple-500/50 focus:ring-purple-500/20 h-12 rounded-xl text-black placeholder:text-gray-500 transition-all hover:bg-white/90"
                />
              </FormControl>
